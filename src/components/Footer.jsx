export default function Footer() {
  return (
    <footer className="h-16 border-t text-center px-2 lg:px-12">
...
export const GithubIcons8 = ({ size = "100" }) => (
...
GithubIcons8.propTypes;

export const LinkedinIcons8 = ({ size = "100" }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={size} height={size} viewBox="0 0 48 48">
      <path
        fill="#0288D1"
