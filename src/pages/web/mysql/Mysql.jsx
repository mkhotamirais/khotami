    ...
    <div>
      ...
      <div>
        ...
        <ul className="list-inside list-disc">
          <li>
            Mysql adalah RDBMD yang digunaan secara luas, gratis, open source, cocok untuk aplikasi kecil maupun besar,
            lintas platform, pertama rilis 1995, dipegang Oracle,{" "}
          </li>
          <li>
          ...
          <li>
            buka xampp control panel pastikan mysql aktif. buka explorer C:\xampp\mysql\bin cari mysql.exe lalu buka jika
            tidak terbuka, cara lain adalah dengan langsung membuka terminal lalu ketik `mysql -u root -p` entar dua kali
          </li>
          <li>
            Syntax
            <pre>{`
...
DELETE FROM table_name WHERE <conditions>
  // jika tanpa operator WHERE maka akan dihapus semua yang terseleksi
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            relational db: menyempurnakan model sebelumnya. Konsepnya mengharuskan data terstruktur dan tersimpan dalam
            bentuk tabel di mana tabel tersebut dapat saling berhubungan. Model ini muncul sekitar 1970-an dan banyak
            digunakan sampai sekarang
          </li>
          <li>
            NoSQL db: not only sql. Menyimpan data tidak dalam bentuk tabular sebagaimana relational db, namun berbentuk
            selain itu: document, key-value, graph. Muncul tahun 2000-an seiring berkembangnya internet dan big-data
          </li>
          <li>
...
UPDATE tbl SET name="abdul" age=10 WHERE id=3
      `}</pre>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            api adalah software penghubung aplikasi. Restful api adalah mekanisme pertukaran data antara client server
            melalui HTTP/HTTPS dengan perantara URL. HTTP: get, post, upt/patch, delete. Data dari client dapat berupa form
            data atau json, response server bisa berupa json atau xml
          </li>
        </ul>
        <div>Relational</div>
        <ul className="list-inside list-disc">
          <li>
            relasi adalah cara desain db berdasar persyaratan dan kebutuhan yang sudah diketahui. Manfaatnya untuk
            pengembangan dan menentukan arah sistem
          </li>
          <li>
          ...
          <li>
            Time relasi: One to One (satu baris data tabel pertama hanya berhubungan satu baris pada tabel kedua), One to
            Many, (satu baris data tabel pertama berhubungan dengan lebih dari satu baris pada tabel kedua), Many to Many
            (lebih dari satu baris data tabel pertama berhubungan dengan lebih dari satu baris pada tabel kedua) sehingga
            menghasilkan tabel perantara sebagai tempat menyimpan foreign key dari masing masing tabel.{" "}
            <a href="https://www.mysqltutorial.org/getting-started-with-mysql/mysql-sample-database/" className="underline">
              sample database
            </a>
          </li>
          <li>
            tipe join: inner join (menampilkan data yang beririsan saja, jadi tidak akan ada data null), left join
            (menampilkan data table kiri dan data yang beririsan, walaupun datanya null), right join (menampilkan data tabel
            kanan dan data yang beririsan walaupun datanya null), full join (menampilkan semua data)
          </li>
        </ul>
      </div>
    </div>
